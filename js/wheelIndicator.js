        ...
        processDelta: function(deltaY)  {
            ...
            if(self.isStopped) {
                ...
                if( (self.memoryAcceleration[2] < self.memoryAcceleration[1]) &&
                    ...
                    //Р  РЎСџР РЋР вЂљР  РЎвЂўР  РЎвЂР  Р’В·Р  РЎвЂўР РЋРІвЂљВ¬Р  Р’В»Р  РЎвЂў Р  Р’В·Р  Р’В°Р РЋРІР‚С™Р РЋРЎвЂњР РЋРІР‚В¦Р  Р’В°Р  Р вЂ¦Р  РЎвЂР  Р’Вµ
                    self.isAcceleration = false;
                }

                if( (self.memoryAcceleration[2] > self.memoryAcceleration[1]) &&
                    (self.memoryAcceleration[1] > self.memoryAcceleration[0])) {
                    //Р  РЎСџР РЋР вЂљР  РЎвЂўР  РЎвЂР  Р’В·Р  РЎвЂўР РЋРІвЂљВ¬Р  Р’В»Р  РЎвЂў Р РЋРЎвЂњР РЋР С“Р  РЎвЂќР  РЎвЂўР РЋР вЂљР  Р’ВµР  Р вЂ¦Р  РЎвЂР  Р’Вµ
